...
class Review(BaseModel):
    summary: list[str]= Field(description =" give a brief summary of the topic")
    sentiment : Literal["pos","neg"]= Field(description=" give sentiment of the review either positive or negative")
